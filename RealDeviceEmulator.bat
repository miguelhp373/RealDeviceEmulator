...
ECHO PARA CONECTAR UM NOVO DISPOSITIVO, VOCÊ DEVE CONECTAR O SEU SMARTPHONE 
ECHO ANDROID AO SEU COMPUTADOR, ATRAVÉS DE UM CABO USB:
ECHO -------------------------------------------------

SET /P $COPTIONS=CASO TENHA CONECTADO O CABO, DIGITE 'S', PARA PROSSEGUIR:

IF $COPTIONS EQU S OR $COPTIONS EQU s GOTO 
...
SET /P $userip= AGORA VOCÊ IRÁ DIGITAR O IP ENCOTRADO ACIMA, EXEMPLO: INET '192.168.0.111' :
